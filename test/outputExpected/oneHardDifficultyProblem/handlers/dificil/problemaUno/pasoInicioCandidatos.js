...
const dataTableImageSource = "https://i.ibb.co/fdDfTMY/paso-Inicio-Candidatos-P3.png";
const graphImageSource = "https://i.ibb.co/PWdcJKs/grafoP3.png";

module.exports = {
	canHandle(handlerInput) {
		return (utils.requestTypeIs(handlerInput,'IntentRequest')
			&& utils.intentNameIs(handlerInput, 'dificilproblemaUnopasoInicioCandidatosIntent')
